...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{figures/Gemini_Generated_Image_tazrz7tazrz7tazr.png}
    \caption{图 0：传统 FALQON 循环与 Neural-FALQON（本文方法）的对比示意图。左图为逐层测量反馈的 FALQON 流程，右图为本文提出的零次推理框架，通过谱-时序 Transformer 一次性预测参数序列并减少量子端开销。}
